    ...
    return (
        <Link to={'/posts/'+post.slug}>
            <Card className="bg-dark text-white rounded-10 shadow-card">
                ...
                <Card.ImgOverlay style={{paddingTop: "60px",
                    background: "linear-gradient(to top, rgba(0, 0, 0, 0.85), transparent)", borderRadius:"10px"}}>
                    <div className="p-5" style={{position:"absolute", left:0, bottom:0}}>
