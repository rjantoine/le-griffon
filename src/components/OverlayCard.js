        ...
        <Link to={'/posts/'+post.slug}>
            <Card className="bg-dark text-white rounded-10 shadow-card">
                ...
                <Card.ImgOverlay style={{paddingTop: "60px", borderRadius:"10px"}}>
                    <div className="p-5 rounded-10 w-100" style={{position:"absolute", left:0, bottom:0, background: "linear-gradient(to top, rgba(0, 0, 0, 0.85), transparent)"}}>
                        <Card.Title as="div" className="h3">{post.frontmatter.shortTitle || post.frontmatter.title}</Card.Title>
