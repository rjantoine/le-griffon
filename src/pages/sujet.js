...
const Sujet = () => {
    return (
        <Theme title="À notre sujet" pathname='/sujet' description="Le Centre communautaire Le Griffon a comme mandat de promouvoir des activités sociales, culturelles, éducatives francophones au Niagara.">
            <Row className="bg-white py-5">
                <Container>
                    <Col>
                        <h1>À notre sujet</h1>
                        <h2>Mandat</h2>
                        <p>Le Centre communautaire Le Griffon a comme mandat de promouvoir sous une gestion commune, des activités sociales, culturelles, éducatives et administratives en plus de coordonner celles-ci avec ses partenaires communautaires dont la population immigrante. De plus, le Griffon est l’organisme qui assure la formation des adultes, des adolescents, des enfants, y compris les immigrants, dans la réalisation d’activités culturelles de tous les genres à l’étendue de la péninsule du Niagara. Les stratégies payantes qui ont été développées depuis les dernières 20 ans par les bénévoles du Griffon continuent à donner des résultats très positifs assurant la vitalité de la communauté Franco-Ontarienne au Niagara. Le Griffon demeure en effet l’organisme rassembleur des divers regroupements francophones de la péninsule. Le Griffon est aussi le premier contact auprès des organismes anglophones pour assurer la participation des francophones aux projets culturels d’envergure à St. Catharines. Enfin, le Griffon assure la promotion et la diffusion de la culture canadienne d’expression française dans la péninsule du Niagara.</p>
                    </Col>
                </Container>
            </Row>
            <Row className="p-5 bg-gray">
                <Container>
                    <Col>
                        <h2>Affiliations</h2>
                        <p>
                            Le Griffon est devenu depuis l’an 2000 l’organisme qui permet à ses nombreux partenaires à réaliser leurs activités communautaires. L’équipe de bénévoles du Griffon fournit à ses partenaires l’appui nécessaire à la réalisation d’activités culturelles et artistiques par la formation des artistes, des vocalistes et des musiciens, la formation en technique de son, la formation des animateurs, la réalisation du décor, la fabrication des mises en scène et la construction des montages artistiques. En formant les jeunes à ce travail, nous faisons un investissement durable pour l’avenir. Nous œuvrons de pair avec plusieurs organismes dont le CERF Niagara et les écoles francophones dans la réalisation de projets culturels. Aussi, il est à mentionner que nous collaborons avec nos nombreux partenaires, soit le Club Richelieu, le Club La Salle de St. Catharines, le Club des Bons Vivants et le Club Alouette de Niagara. Le Griffon a tissé un partenariat étroit avec SOFIFRAN, Solidarité des Femmes Immigrantes du Niagara et avec le St. Catharines Folk Arts Council dans le but de réaliser de nombreuses activités culturelles annuellement pour les nouveaux-arrivants de la péninsule du Niagara ainsi que la population francophone de souche. Le Griffon cherche à multiplier ses partenariats dans le but d’assurer la vitalité de la communauté francophone de Niagara.
                        </p>
                    </Col>
                </Container>
            </Row>
